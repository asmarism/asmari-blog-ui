          ...
          <div className="space-y-6 animate-in fade-in duration-700">
            {filteredPosts.map((post, idx) => (
              <a 
                ...
                key={post.id} 
                className="block group liquid-glass rounded-[2rem] overflow-hidden hover:border-[#1B19A8]/50 transition-all duration-500 cursor-pointer text-inherit no-underline"
